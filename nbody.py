...
def solar_system(gpu=False):
	...
	if gpu:
		...
		v = cp.array([[0,0,0],
			...
			[5477.0e0,0,5.0],
			[4748.0e0,0,0]])
		m=cp.array([1.989e30,3.285e23,4.867e24,5.972e24,6.39e23,1.898e27,5.683e26,8.681e25,1.024e26,1.309e22])
	else:
		...
		v = np.array([[0,0,0],
			...
			[5477.0e0,0,5.0],
			[4748.0e0,0,0]])
		m=np.array([1.989e30,3.285e23,4.867e24,5.972e24,6.39e23,1.898e27,5.683e26,8.681e25,1.024e26,1.309e22])
